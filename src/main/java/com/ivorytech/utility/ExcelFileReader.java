...
public class ExcelFileReader implements WebElementAction{
...
public ExcelFileReader(String path) {
		...
		//ExcelFileReader.path=path;
		try {
			fis = new FileInputStream(path);
			workbook = new XSSFWorkbook(fis);

			sheet = workbook.getSheetAt(1); // A supprimer après
			fis.close();
		} catch (Exception e) {
...
public static void Navigate(String url){ 
  ...
  // find whether sheets exists	
	...
	public static boolean addHyperLink(String sheetName,String screenShotColName,String testCaseName,int index,String url,String message){
